...
public class HazardousActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView      = findViewById(R.id.recyclerView_hazardous);
        ...
        home.setOnClickListener(v ->
                redirectActivity(HazardousActivity.this, MainActivity.class));
        dustbins.setOnClickListener(v ->
                redirectActivity(HazardousActivity.this, DustbinActivity.class));
        fullDustbins.setOnClickListener(v ->
                redirectActivity(HazardousActivity.this, FullDustbinsActivity.class));
        hazardousDustbins.setOnClickListener(v -> recreate()); // already here
        complaints.setOnClickListener(v ->
                redirectActivity(HazardousActivity.this, ComplaintsActivity.class));
        notifications.setOnClickListener(v ->
                redirectActivity(HazardousActivity.this, NotificationActivity.class));
        logout.setOnClickListener(v -> {
            SessionManager sessionManager = new SessionManager(HazardousActivity.this);
            sessionManager.clearSession();

            Toast.makeText(this, "Logged out", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(HazardousActivity.this, LoginActivity.class);
        ...
        loadHazardousDustbins();
    }

    private void loadHazardousDustbins() {
        ...
        dustbinRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dustbinSnapshot : snapshot.getChildren()) {
                    ...
                    if (dustbin != null && "Danger".equals(dustbin.getGasStatus())) {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(HazardousActivity.this,
